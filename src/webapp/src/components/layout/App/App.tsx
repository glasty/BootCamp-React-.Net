  ...
  return (
    <div>      
        <div className={`${styles.sideMenu}`} style={{width: menuPanel}}>
          <span className={`${styles.closeButton}`} onClick={() => {setMenuPanel(0)}}>x</span>

          <button type="button" className={`${styles.sideButtonMenu}`} onClick={addMovieHandler}>Add Movie</button>
          <button type="button" onClick={() => console.log(movies)} className={`${styles.sideButtonMenu}`}>Add Genre</button>
